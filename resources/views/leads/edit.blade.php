        ...
        <div class="col-12 col-lg-10 col-xl-8">
            <div class="card lead-form-card">
                <div class="card-header-lead d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h1 class="h5 mb-0 text-white fw-semibold">Edit Lead</h1>
                        <p class="mb-0 small text-white text-opacity-75">Update contact and status for this lead</p>
                    </div>
                </div>
                <div class="card-body p-4 p-md-5">
                    <form method="POST" action="{{ route('leads.update', $lead) }}" class="lead-form">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control rounded-3 @error('name') is-invalid @enderror"
                                           id="name" name="name" value="{{ old('name', $lead->name) }}" placeholder=" " required autocomplete="name">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="email" class="form-control rounded-3 @error('email') is-invalid @enderror"
                                           id="email" name="email" value="{{ old('email', $lead->email) }}" placeholder=" " required autocomplete="email">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control rounded-3 @error('phone') is-invalid @enderror"
                                           id="phone" name="phone" value="{{ old('phone', $lead->phone) }}" placeholder=" " required inputmode="numeric" autocomplete="tel">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select class="form-select rounded-3 @error('status') is-invalid @enderror" id="status" name="status" required>
                                        <option value="" disabled {{ old('status', $lead->status) ? '' : 'selected' }}>Choose status</option>
